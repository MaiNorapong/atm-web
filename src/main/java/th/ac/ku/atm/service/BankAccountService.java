...
public class BankAccountService {
    ...
    public List<BankAccount> getCustomerBankAccount(int customerId) {
        String url = "http://bank:8091/api/bankaccount/customer/" + customerId;
    ...
    public void openAccount(BankAccount bankAccount) {
        String url = "http://bank:8091/api/bankaccount";
    ...
    public BankAccount getBankAccount(int id) {
        String url = "http://bank:8091/api/bankaccount/" + id;
        ResponseEntity<BankAccount> response = restTemplate.getForEntity(url, BankAccount.class);
        return response.getBody();
    }

    public void editBankAccount(BankAccount bankAccount) {
        String url = "http://bank:8091/api/bankaccount/" + bankAccount.getId();
    ...
    public void deposit(int id, Money money) {
        String url = "http://bank:8091/api/bankaccount/deposit/" + id;
        restTemplate.postForObject(url, money, Money.class);
    }

    public void withdraw(int id, Money money) {
        String url = "http://bank:8091/api/bankaccount/withdraw/" + id;
        restTemplate.postForObject(url, money, Money.class);
    }
}
